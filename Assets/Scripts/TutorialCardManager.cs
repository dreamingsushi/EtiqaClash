...
public class TutorialCardManager : MonoBehaviour
{
    ...
    public static TutorialCardManager Instance;
    private TutorialCards selectedCard;
    ...
    public void SelectCard(TutorialCards newCard)
    {
    ...
    public void SpawnNewCard(TutorialCards.CardType cardType)
    {
        foreach (GameObject cardPrefab in cardPrefabs)
        {
            TutorialCards cardComponent = cardPrefab.GetComponent<TutorialCards>();
    ...
    public void DestroySelectedCard()
    {
        if (selectedCard != null)
        {
            ...
            TutorialCards.CardType cardType = selectedCard.currentCard;
